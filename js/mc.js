...
function updateBadge(n) {
  ...
  if (!$btn.find(".chat-badge").length) {
    $btn.css("position","relative")
        .append('<span class="chat-badge" style="position:absolute;top:-4px;right:-4px;background:#dc3545;color:#fff;border-radius:12px;padding:0 6px;font-size:12px;">0</span>');
  }
